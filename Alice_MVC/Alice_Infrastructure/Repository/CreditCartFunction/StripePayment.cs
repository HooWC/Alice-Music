...
namespace Alice_Infrastructure.Repository.CreditCartFunction
{
			...
			try
			{
				...
				var tokenOptions = new TokenCreateOptions
				{
					Card = new TokenCardOptions
					{
						...
						ExpYear = _dtoCreditDebitCard.ExpYear.ToString(),
						ExpMonth = _dtoCreditDebitCard.ExpMonth.ToString(),
